    ...
    return (<>
        <div>
            <div className='section1'>
                <div style={{ background: `url(${image1}) right fixed no-repeat`, backgroundSize: 'cover', minHeight: '100vh', width: '100%', paddingTop:'70px' }}>
                    <div className='p-3'>
                        <div className='row'>
            ...
            <div className='section3'>
                <div className='p-3' style={{ background: `url(${image3})`, height: '100vh' }}>
